...
Logbook significa diario di bordo. Uno degli obbiettivi è anche quello di creare un diario che agevoli la propria organizzazione con lo scopo diincrementare la propria reddittivit�. Deve creare, inoltre, un contatto fra le diverse risorse del team. Una sorta di social network aziendale.
...
Il progetto può anche indicare un reparto di un'azienda, attualmente non ha un inizio, una fine, ne obbiettivi o milestones
Ogni progetto può avere diversi incarichi e questi diverse attività.
L'incarico ha uno stato impostato in automatico dagli eventi, mediante il plugin state_machine
La compilazione quotidiana della risorsa e l'attività. E' quella che dovrebbe essere utilizzata per creare il diario.
...
Sotto il calendario c'è un riepilogo con le ultime attività inserite dalle risorse.
...
* Migliorare la sezione project managment ed implementare quella social network
